...
public class E2E : BaseClass
{
    ...
    {
        getExtentTest().Log(Status.Info, "username" + username);
        ...
        getExtentTest().Log(Status.Pass, "successfull login with username" + username);
        ...
        getExtentTest().Log(Status.Pass, "Product added successfully");
        ...
        getExtentTest().Log(Status.Pass, "Expected products for added" + productList);
        ...
        getExtentTest().Log(Status.Pass, "Products purchased successfully");
